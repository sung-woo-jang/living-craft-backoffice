...
export function FilmCuttingPage() {
  ...
  return (
    <div className={styles.page}>
              ...
              {(
                ...
                const progressRate =
                  project.pieceCount > 0
                    ? Math.round(
                        (project.completedPieceCount / project.pieceCount) * 100
                      )
                    : 0
                ...
                return (
                  <tr key={project.id}>
                    ...
                    <td className={styles.tdCenter}>{project.pieceCount}개</td>
      ...
      {!isLoading &&
        !error &&
        (!data?.data || (data.data as unknown as Array<unknown>).length === 0) && (
